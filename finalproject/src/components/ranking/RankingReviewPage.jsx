...
import { FaArrowLeft, FaMedal, FaPenNib, FaHeart, FaUser, FaCrown } from "react-icons/fa6";
...
export default function RankingReviewPage() {
    ...
    useEffect(() => {
        axios.get("/api/ranking/review?limit=20")
                ...
                <div className="mb-5">
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                        <h2 className="fw-bold text-white m-0 d-flex align-items-center display-6">
                            <span className="me-3 p-2 rounded-circle bg-success bg-opacity-10">
                                <FaPenNib className="text-success" size={32} />
                            </span>
                            이달의 리뷰왕
                        </h2>
                            ...
                            >
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="d-flex flex-column justify-content-center">
                                        ...
                                        <small className="text-secondary" style={{fontSize: '0.85em'}}>
                                            <FaPenNib className="me-1" size={10}/>
                                            총 리뷰 <span className="text-success fw-bold">{item.reviewCount}</span>개 작성
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div className="pe-3">
                                    <div className={`px-4 py-2 rounded-pill fw-bold shadow-sm d-flex align-items-center gap-2 ${
                                        ...
                                        'bg-dark border border-secondary text-danger'
                                    }`}>
                                        <FaHeart />
                                        <span className={index === 0 ? 'text-white' : 'text-light'}>{item.count}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
